<template>
  <div class="Chatroom">
    ...
    <div class="send">
      <input placeholder="Say something..." v-model="input" />
...
export default class Chatroom extends Vue {
  ...
  private _client = new WsClient(serviceProto, {
  ...
  async send(): Promise<void> {
    let ret = await this._client.callApi("Send", {
      content: this.input,
    });
